...
import 'package:news_app/inner_screen/search_sccreen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
        ...
        child: Scaffold(
            ...
            appBar: AppBar(
              ...
              actions: [
                IconButton(
                    onPressed: () {
                      Navigator.push(context, PageTransition(child:const  SearchScreen(),
                  ...
                  FutureBuilder<List<NewsModel>>(
                    future: newsType==NewsType.topTrending?newsProvider.fetchTopHeadlines()
                      ...
                      if(snapshot.connectionState==ConnectionState.waiting){
                        ...
                        return Expanded(child: EmptyNewsWidget(text: 'An error has occured${snapshot.error}',
                          imagePath: 'assets/images/no_news.png',));

                      }else if(snapshot.data==null){
                        return const Expanded(child: EmptyNewsWidget(text: 'No news found',
                          imagePath: 'assets/images/no_news.png',));
 ...
 //                  })),
 //=================================Show top trending widget========================================================
                  /*if(newsType==NewsType.topTrending)
                    SizedBox(
                      height: size.height*.6,
                      child: Swiper(itemCount: 5,
                      viewportFraction: 0.9,
                        itemWidth: size.width * 0.9,
                      layout: SwiperLayout.STACK,
                      itemBuilder: (ctx,index){
